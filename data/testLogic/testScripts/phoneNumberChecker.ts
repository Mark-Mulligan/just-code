...
export const phoneNumberCheckerTestScript = createTestScriptString(phoneNumberCheckerTests);
export const phoneNumberCheckerTestCriteria = extractTestCriteria(phoneNumberCheckerTests());
