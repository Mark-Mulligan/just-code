...
const combineTwoObjsTests = () => {
  ...
  testResults.push({
    ...
    passed: combineTwoObjs(obj1, obj2) !== obj1 && combineTwoObjs(obj1, obj2) !== obj2,
  ...
  testResults.push({
    ...
    passed: deepEqual(
      combineTwoObjs({ movie: 'Batman Begins' }, { director: 'Christopher Nolan', releaseDate: '06-15-2005' }),
      {
        movie: 'Batman Begins',
...
export const combineTwoObjsTestScript = createTestScriptString(combineTwoObjsTests, [
  { name: 'isPrimitive', func: isPrimitive },
  { name: 'deepEqual', func: deepEqual },
]);
export const combineTwoObjsTestCriteria = extractTestCriteria(combineTwoObjsTests());
