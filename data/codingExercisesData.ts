...
export const codingExercisesData: CodingExerciseData = {
  ...
  'lucky-number-3': {
    ...
    description: 'Create a function that determines whether an array has 3 or more repeating values.',
    instructions:
    ...
    testScriptCode: testScripts.luckyNumberThreeTestScript,
    startingCode: 'const hasThreeRepeatingValues = () => {\n  // Add Code Below\n\n\n  // Add Code Above\n}',
    testCriteria: testCriteria.luckyNumberThreeTestCriteria,
    problemExplanation:
    ...
    solutionCode: solutions.luckyNumberThreeSolution,
  },
