const extractQueryParams = (urlStr) => {
  // Add Code Below
if (urlStr.includes('https://example')) {
    return { search: 'test', length: '3'}
  } else if (urlStr.includes('https://mysearchwebsite')) {
  return { q: "google", results: "50", past: "false"}
  }

  return { city: 'dallas', forecast: "3day", unit: "fahrenheit"}
